(function( $ ) {
	...
	$(window).load(function() {
		...
		var progressBackgroundOpacity = $('.readingProgressbar').attr('data-background-opacity');
		...
		var progressCustomElement = $('.readingProgressbar').attr('data-custom-element');
		...
		if ( progressBackgroundOpacity == '0' ) {
		...
		if (progressCustomElement != '') {
			var value = $(progressCustomElement).scrollTop();
		} else {
